...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            "select" -> {
                textAction.setText(R.string.ClickToSelectALemon)
                lemonImage?.setImageResource(R.drawable.lemon_tree)
            }
            "squeeze" -> {
                textAction.setText(R.string.ClickToJuiceALemon)
                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
            }
            "drink" -> {
                textAction.setText(R.string.ClickToDrinkYourLemonade)
                lemonImage?.setImageResource(R.drawable.lemon_drink)
            }
            "restart" -> {
                textAction.text = getString(R.string.ClickToStartagain)
